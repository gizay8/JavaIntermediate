...
public class Question {
    ...
    public static boolean insertData(String q, String o1, String o2, String o3, String o4,int answer, int course_id) {
        ...
        try {
            ...
            prst =conn.prepareStatement("INSERT INTO public.\"question\"(question,o1,o2,o3,o4,answer,content_id) VALUES (?,?,?,?,?,?,?)");
            prst.setString(1,q);
            prst.setString(2,o1);
            prst.setString(3,o2);
            prst.setString(4,o3);
    ...
    public static boolean updateData(int id, String question, String o1, String o2, String o3, String o4, int answer) {
        ...
        try {
            conn=DBConnector.getInstance();
            prst =conn.prepareStatement("UPDATE public.\"question\" SET question=?,o1=?,o2=?,o3=?,o4=?,answer=? WHERE id=?;");
    ...
    public static ArrayList<Question> getList(int content_id) {
        ...
        try {
            conn=DBConnector.getInstance();
            prst=conn.prepareStatement("SELECT * FROM public.\"question\" where content_id=? ORDER BY id;");
    ...
    public static Question getFetch(int id) {
        Question obj =null;
        String query="Select * from public.\"question\" WHERE id=? ";
        Connection conn=null;
        PreparedStatement prst=null;
        ResultSet rs=null;
        try {
    ...
    public static boolean deleteData(int id) {
        ...
        try {
            conn=DBConnector.getInstance();
            prst =conn.prepareStatement("DELETE FROM public.\"question\"  WHERE id=?;");
            prst.setInt(1,id);
    ...
    public static boolean deleteQuestion(int id) {
        ...
        try {
            conn=DBConnector.getInstance();
            prst =conn.prepareStatement("DELETE FROM public.\"question\"  WHERE content_id=?;");
            prst.setInt(1,id);
    ...
    public static Question getFetch(String q) {
        Question obj =null;
        String query="Select * from public.\"question\" WHERE question=? ";
        Connection conn=null;
        PreparedStatement prst=null;
        ResultSet rs=null;
        try {
